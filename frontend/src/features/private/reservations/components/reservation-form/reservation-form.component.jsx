            ...
            <FormItem>
              ...
              >
                <FormControl>
                  <SelectTrigger>
                    <SelectValue
                      placeholder={constants.FORM_FIELD_SERVICE_ID.placeholder}
                    />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
                  ...
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={constants.FORM_FIELD_YEAR.placeholder}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                  ...
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={constants.FORM_FIELD_MONTH.placeholder}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        {getMonths({ year: reservation.year }).map((month) => (
